...
if(isset($_POST['LogIn'])) {
    ...
    $staff = "SELECT * FROM tblstaff WHERE username='$username' AND password='$password' ";
    $result_staff = $con->query($staff);

    $resident = "SELECT * FROM tblresident WHERE firstname='$username' AND lastname='$password' ";
    $result_staff = $con->query($staff);

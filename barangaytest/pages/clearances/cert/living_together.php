                        ...
                        if(mysqli_num_rows($query_run) > 0)
                        {
                            foreach($query_run as $row)
                            {
                                ?> 
                                    ...
                                    <p style="text-align: center; font-size: 20px;">Ito rin ay nagpapatunay na ang mga sumusunod ay kanilang mga anak:</p></br></br>
                                    <p style="text-align: center; font-size: 20px;"><b>FAITH MARJORIE</b></p></br>
                                    <p style="text-align: center; font-size: 20px; margin-top:-20px"><b>AEZEL</b></p></br></br></br>
                                    <p class="intro">Ang pagpapatunay na ito ay iginawad kay <b><?php echo $row['firstname'];?><?php echo $row['lastname']; ?></b> Iginawad ngayong ika- <b><?php date_default_timezone_set('Asia/Tokyo'); $currentDateTime = date('j'); echo $currentDateTime;?> ng <?php date_default_timezone_set('Asia/Tokyo'); $currentDateTime = date('F Y'); echo $currentDateTime;?></b> dito sa Tanggapan ng Punong Barangay ng Barangay Collado, Talavera, Nueva Ecija.</p></br></br>
                                <?php
                            }
                        }
                        else

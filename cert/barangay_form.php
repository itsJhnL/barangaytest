...
<html id="clearance">
<link rel="stylesheet" href="../css/bargy.css">
<head>
    ...
    <div class="book">
        <div class="page">
            ...
            <div class="topright">
                ...
                ?>
                        <div style="font-size: 25px; margin-top: -500px;">                  
                            ...
                            if(isset($_GET['id']))
                            {
                                ...
                                if(mysqli_num_rows($query_run) > 0)
                                {
                                    foreach($query_run as $row)
                                    {
                                        ?>
                                            <div class="main">
                                                <p style="font-size: 20px; margin-top:-1000px; right: 49px; position: relative;"><b>TO WHOM IT MAY CONCERN:</p></b>
                                                <p style="font-size: 20px; margin-top:-90px; right: -247px; position: relative;"><b><?php date_default_timezone_set('Asia/Tokyo'); $currentDateTime = date('F j, Y - g:i:A'); echo $currentDateTime;?></p></b>
                                                ...
                                                <p style="font-size: 20px; margin-top:130px; right: 70px; position: relative;">Community Tax No.</p>
                                        ...
                                        ?>
                                                ...
                                                <div class="bottom"><img src="man.webp"  style="width:140px; height: 140px; margin-top:-500px; right: 220px; position: relative; border-style: solid; border-color: blue;"/></div>
                                            </div>
                                            <p style="position: fixed;  left: 0;  bottom: 0;  width: 100%; font-size: 20px; text-align: center;"><b>Note: Valid until December 31, 2023 unless otherwise revoke</p></b>

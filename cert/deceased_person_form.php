                        ...
                        if(mysqli_num_rows($query_run) > 0)
                        {
                            foreach($query_run as $row)
                            {
                                ?>
                                    ...
                                    <p class="intro">Ito ay isang patunay na si <b> <?php echo $row['firstname']; ?> <?php echo $row['middlename']; ?> <?php echo $row['lastname']; ?>, 21 years old </b> taong gulang na naninirahan sa <b> PUROK 4</b> ng Barangay na ito ay pumanaw na noong ika-7th ng February ng taong ito sa ganap na ika-<b>7:28</b> pm sa kanilang tahanan.<br></p>   

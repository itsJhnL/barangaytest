  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <div class="modal-header">
        <img src="../../includes/assets/img/talavera_logo.png" class="w-auto" height="50" alt="Logo">
        <h5 class="modal-title mx-2" id="staticBackdropLabel">Generate Information</h5>
        ...
        <div class="container">
          ...
          <form action="function.php" method="POST">
            ...
            <div class="row g-2 mb-2">
              <div class="col input-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="contactNo" placeholder="" autocomplete="off" required value="<?php echo $row['contactNo']; ?>">
                </div>
              </div>
              <div class="col input-group">
                <label>Gender</label>
            ...
            <div class="modal-footer">
              <button type="submit" name="update_resident" class="btn btn-light" data-bs-dismiss="modal">Update</button>
              <a href="cert/goodmoral_form.php" target="_blank" type="button" name="print" class="btn btn-primary">Generate</a>
            </div>
